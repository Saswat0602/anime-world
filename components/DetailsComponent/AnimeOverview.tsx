    ...
    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
      <div className="p-5 space-y-4">
        ...
        <div>
          ...
          <p className="text-gray-900 dark:text-white">{anime.season ? `${anime.season.charAt(0).toUpperCase() + anime.season.slice(1).toLowerCase()} ${anime.seasonYear}` : 'N/A'}</p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1">
            {anime.studios.edges
              ...
              .map((edge: any) => (
                <span key={edge.node.id} className="text-blue-600 dark:text-blue-400 hover:underline cursor-pointer">
                  {edge.node.name}
                </span>
              ))}
          </div>
        ...
        <div>
          ...
          <p className="text-gray-900 dark:text-white">{anime.source?.replace(/_/g, ' ') || 'Original'}</p>
        </div>
