    ...
    <div className="relative w-full">
      ...
      <div className="container mx-auto px-4">
        <div className="relative flex flex-col md:flex-row -mt-32 z-10">
          {/* Cover Image */}
          <div className="w-40 h-56 md:w-48 md:h-64 flex-shrink-0 rounded overflow-hidden border-4 border-gray-800 shadow-lg">
            <Image
          ...
          <div className="mt-4 md:mt-0 md:ml-8 flex-grow">
            <div className="bg-gray-800 bg-opacity-90 p-4 md:p-6 rounded">
              ...
              <div className="flex items-center space-x-4">
                <button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded flex items-center space-x-2 transition">
                  <span>Add to List</span>
                </button>
                <button className="bg-pink-600 hover:bg-pink-700 text-white p-2 rounded transition">
                  <Heart size={20} />
                </button>
              </div>
            </div>
